...
%grace a ce projet j'ai pu apprendre le coté orienté objet du python que je n'avais jamais vu pour le moment
%de même j'ai appris a manipuler SageMath et pas les fonctions du paquet oreAlgebra
%de maniere un peu plus large j'ai aussi appris le LateX 